...
func make(the card: Card, riseToTheTopOfThe deck: Deck) -> Deck {
    var deck = deck
...
let queenFirstDeck = make(the: queenOfHearts, riseToTheTopOfThe: freshDeck)

let fourFirstDeck = make(the: fourOfSpades, riseToTheTopOfThe: queenFirstDeck)
...
result = freshDeck.moveToTheTop(the: queenOfHearts).moveToTheTop(the: fourOfSpades)
